    ...
    with open(csv_path) as f:
        ...
        if save:
            ...
            if save:
                ...
                # np.savez(csv_path[:csv_path.find(".csv")] + "_" + str(horizon) + "RNN_Val.npz", features=features_refine, 
                #         labels=labels_refine,times_features=time_features_refine, times = timelines_refine)
